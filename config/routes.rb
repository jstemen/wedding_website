Rails.application.routes.draw do
  ...
  get 'invitation_groups/show/:code/show_events_already_confirmed', to: 'invitation_groups#show_events_already_confirmed', as: 'show_events_already_confirmed'
  ...
  get 'reminder_emails', to: 'reminder_emails#index', as: 'reminder_emails'
  post 'reminder_emails', to: 'reminder_emails#send_email_reminders', as: 'send_reminder_emails'
end
